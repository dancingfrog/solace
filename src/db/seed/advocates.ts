...
const getRandomSelectionOfSpecialties = (spec: [string], range: [number, number]) => {
  if (typeof range[0] === "number" && typeof range[1] === "number") {
    return spec.slice(range[0], range[1]);
  } else {
    return spec;
  }
}
...
const advocateData = [
  {
    ...
    city: "New York",
    degree: "MD",
    specialties: getRandomSelectionOfSpecialties(specialties, randomSpecialty()),
